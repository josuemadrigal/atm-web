        ...
        <div className="lg:bg-gray-50 dark:lg:bg-darker lg:p-16 rounded-[4rem] space-y-6 md:flex flex-row-reverse md:gap-6 justify-center md:space-y-0 lg:items-center">
          ...
          <div className="md:7/12 lg:w-1/2">
            ...
            <p className="my-8 text-gray-600 dark:text-gray-300">
              Having an Automated Teller Machine (ATM) can offer various
              benefits, such as providing convenience to customers by offering
              easy and quick access to banking services 24/7. Additionally, it
              reduces the load on bank branches, improves efficiency in
              transactions, and facilitates cash withdrawal in diverse
              locations, which is particularly useful in emergency situations.
            </p>
